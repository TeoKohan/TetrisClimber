Shader "Block/Portal" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			fixed4 col = sin(IN.worldPos.y + _Time[1]) * _Color1 - (1 - sin(IN.worldPos.y + _Time[1])) * _Color2;
			...
			o.Emission = _RimColor.rgb * pow (rim, _RimPower) + clamp(0.5 - _Health, 0.0, 1.0) * clamp(tex * 10, 0, 10);
			o.Emission = clamp(tex * 2, 0, 0);
